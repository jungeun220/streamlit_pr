...
def main() :
    ...
    # 체크박스 : 둘 중에 하나만 선택하게 끔 만들 때. (체크/해제)
    # 체크하면, 헤드 5개를 보여주고, 해체하면 안보여주도록 한다.
    ...
    age = st.slider('나이', 1, 120, 1, 1)
    st.text(f'선택한 나이는 {age}세 입니다')
